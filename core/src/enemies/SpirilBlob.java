...
public class SpirilBlob implements Enemies 
{
	private int health;
	 ...
	 */
	public SpirilBlob(int Health, float deg, float speed, float distance, float diameter, Color color, World world, boolean Left)
	{
